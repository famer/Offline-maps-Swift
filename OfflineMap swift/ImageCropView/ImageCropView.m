...
- (void)viewDidLoad
{
    ...
    if (self){
        ...
        buttonCancel.frame = CGRectMake(10.0, 0.0, 160.0, 40.0);
        ...
        buttonDone.frame = CGRectMake(180.0, 0.0, 160.0, 40.0);
...
- (IBAction)done:(id)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(imageCropViewControllerDidFinish:didFinishCroppingImage:)])
    {
        UIImage *cropped;
        if (self.image != nil){
        ...
        [self.delegate imageCropViewControllerDidFinish:self didFinishCroppingImage:cropped];
    }
